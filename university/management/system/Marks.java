...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollno) {
        ...
        JLabel heading = new JLabel("Vadodara Univeristy");
        ...
        subheading.setFont(new Font("Times New Roman", Font.BOLD, 18));
        add(subheading);
        
        JLabel lblrollno = new JLabel("Roll Number " + rollno);
        lblrollno.setBounds(60, 100, 500, 20);
        lblrollno.setFont(new Font("Century Schoolbook", Font.PLAIN, 16));
        add(lblrollno);
        
        JLabel lblsemester = new JLabel();
        lblsemester.setBounds(60, 130, 500, 20);
        lblsemester.setFont(new Font("Century Schoolbook", Font.PLAIN, 18));
        add(lblsemester);
