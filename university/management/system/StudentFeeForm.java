...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        image.setBounds(500, 50, 280, 350);
        add(image);
        
        JLabel lblrollnumber = new JLabel("Select Roll No");
        lblrollnumber.setBounds(40, 60, 150, 20);
        lblrollnumber.setFont(new Font("Times New Roman", Font.BOLD, 16));
        add(lblrollnumber);
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from student5");
            while(rs.next()) {
        ...
        labelfname.setFont(new Font("Times New Roman", Font.PLAIN, 16));
        add(labelfname);
        
        try {
            Conn c = new Conn();
            String query = "select * from student5 where rollno='"+crollno.getSelectedItem()+"'";
        ...
        String course[] = {"B.Tech", "B.A", "BCA", "BSC", "MSc", "MBA", "MCA", "M.Com", "B.Com"};
        ...
        labeltotal.setFont(new Font("Times New Roman", Font.PLAIN, 16));
        add(labeltotal);
        
        total = new JButton("Total");
        total.setBounds(30, 380, 100, 25);
        ...
        pay.setFont(new Font("Times New Roman", Font.BOLD, 15));
        add(pay);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == total) {
            ...
            try {
                ...
                String query = "insert into collegefee1 values('"+rollno+"', '"+course+"', '"+branch+"', '"+semester+"', '"+total+"')";
