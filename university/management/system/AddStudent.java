...
public class AddStudent extends JFrame implements ActionListener{
    ...
    AddStudent() {
        ...
        dcdob.setBounds(600, 200, 170, 30);
        add(dcdob);
        ...
        tfxii.setBounds(200, 350, 170, 30);
        add(tfxii);
        ...
        String course[] = {"B.Tech", "BBA", "BCA", "Bsc","M.Tech", "Msc", "MBA", "MCA", "MCom", "MA", "BA"};
        cbcourse = new JComboBox(course);
        cbcourse.setBounds(200, 400, 170, 30);
        ...
        cbbranch.setBounds(600, 400, 170, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "insert into student5 values('"+name+"', '"+fname+"', '"+rollno+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+aadhar+"', '"+course+"', '"+branch+"')";
